	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				half2 texCoord9 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half2 Offset75 = ( ( 0.0 - 1 ) * ase_tanViewDir.xy * _BackDepthScale ) + texCoord9;
				float2 OffsetBack70 = Offset75;
				half2 Offset76 = ( ( 0.0 - 1 ) * ase_tanViewDir.xy * _MidDepthScale ) + texCoord9;
				...
				half4 tex2DNode62 = tex2D( _Mask, texCoord9 );
				half4 lerpResult58 = lerp( lerpResult48 , tex2D( _Front, texCoord9 ) , tex2DNode62.r);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				half2 texCoord9 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
					...
					)
			{
				...
				half2 texCoord9 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				half4 tex2DNode62 = tex2D( _Mask, texCoord9 );
				half temp_output_87_0 = ( 1.0 - tex2DNode62.r );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				half2 texCoord9 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=18900
-1920;0;1920;1019;1872.586;-23.31848;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;46;-323.2037,449.3041;Inherit;True;Property;_Mid;Mid;3;0;Create;True;0;0;0;False;0;False;-1;None;7b120c3c3229f1245b47281ba7c9b80b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;45;-326.5037,181.3044;Inherit;True;Property;_Back;Back;0;0;Create;True;0;0;0;False;0;False;-1;None;68238187342e117439ce4507180c5a9f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8CFB6ECC70054408E3E23F0239622040BFD229E9