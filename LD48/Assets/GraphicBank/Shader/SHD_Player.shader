...
Shader "SHD_Player"
{
	Properties
	{
		...
		[ASEEnd]_Color("Color", Color) = (0.5647059,0.909804,0.8784314,1)
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 temp_output_86_0 = ( SampleGradient( gradient85, frac( ( ( _FringeOffsetm + (0.0 + (atan2( objToViewDir74.x , objToViewDir74.y ) - PI) * (1.0 - 0.0) / (( -1.0 * PI ) - PI)) ) * _FringeTiling ) ) ) + _FringeBoost );
				...
				surfaceDescription.Albedo = lerpResult88.rgb;
				...
				surfaceDescription.Alpha = temp_output_68_0;
		...
		Pass
		{
					...
					)
			{
				...
				float3 ase_worldNormal = packedInput.ase_texcoord1.xyz;
				float fresnelNdotV60 = dot( ase_worldNormal, V );
				float fresnelNode60 = ( 0.0 + _TransparencyFresnelScale * pow( max( 1.0 - fresnelNdotV60 , 0.0001 ), _TransparencyFresnelPower ) );
				float temp_output_68_0 = saturate( ( 1.0 - saturate( fresnelNode60 ) ) );
...
/*ASEBEGIN
Version=18900
-1920;0;1920;1019;1280.899;204.3472;1;True;True
...
Node;AmplifyShaderEditor.SaturateNode;68;-897.6162,128.6967;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;49;9;68;0
ASEEND*/
//CHKSM=C4ED337B5F160DD4D5398D53D91DA57DF44E8498