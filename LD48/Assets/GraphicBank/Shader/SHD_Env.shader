...
Shader "SHD_Env"
{
	Properties
	{
		...
		[ASEEnd]_SelfTransition("SelfTransition", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 temp_cast_1 = (lerpResult31).xxx;
...
/*ASEBEGIN
Version=18900
-1920;18;1920;1001;837.9879;-346.4627;1;True;True
...
ASEEND*/
//CHKSM=1FDD1A2DD68B9E44D77540E40D75B3B44D3A20E7