	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 triplanar73 = TriplanarSampling73( _TopTexture0, ase_worldPos, normalWS, 1.0, float2( 0.1,0.1 ), 1.0, 0 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar73 = TriplanarSampling73( _TopTexture0, ase_worldPos, ase_worldNormal, 1.0, float2( 0.1,0.1 ), 1.0, 0 );
				float temp_output_39_0 = ( 1.0 - saturate( ( ( ( distance( _DioramaPos , ase_worldPos ) * 0.2 ) + temp_output_28_0 ) + triplanar73.x ) ) );
				float4 lerpResult29 = lerp( float4( 1,1,1,0 ) , ( tex2D( _Diffuse, lerpResult64 ) * _Color ) , temp_output_39_0);
				float4 temp_cast_0 = (0.7).xxxx;
				float4 lerpResult78 = lerp( lerpResult29 , temp_cast_0 , _WinterTransi);
...
/*ASEBEGIN
Version=18900
-1920;0;1920;1019;1043.322;714.0354;1;True;True
...
Node;AmplifyShaderEditor.TriplanarNode;73;-640.6042,1350.901;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;0;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;BrushMask;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;0.1,0.1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=2CFCA40843B794457332958D163923E94971D637